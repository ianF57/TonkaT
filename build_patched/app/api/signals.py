...
async def get_signals(
    ...
    """Generate signals from stored historical data (DB-only).

    Returns 422 with a clear message if backfill hasn't been run yet.
    """
    try:
        ...
        logger.exception("Unexpected signals error: asset=%s tf=%s", asset, timeframe)
